    ...
    try {
      if (args[0]) {
        ...
        const baseembed = new MessageEmbed()
          ...
          .setDescription(`
💪  **==>** Untuk melihat perintah **Source Help** Commands

💰  **==>** Untuk melihat perintah **Premium** Commands

🔰  **==>** Untuk melihat perintah **Information** Commands

🕹️  **==>** Untuk melihat perintah **Fun** Commands

🎶  **==>** Untuk melihat perintah **Music** Commands

👀  **==>** Untuk melihat perintah **Audio Filter** Commands

⚜️  **==>** Untuk melihat perintah **Saved (custom) Queue** Commands
${owner == true ? `\n👑 **==>** Untuk melihat perintah **Owner** Commands` : ""}
${userperms == true ? `\n⚙️ **==>** Untuk melihat perintah **Setting** Commands

🚫  **==>** Untuk melihat perintah **Administration** Commands` : ""}
`)
